...
--]]---------------------------------------------------------------------------
local ProjectObserver = co.Component( "lab3d.core.domain.ProjectObserver" )
...
function M:addObserver( obsTable )
	if not self.observers then
		...
		co.system.services:getService( co.Type["lab3d.core.IApplication"] ):addProjectObserver( M.instance )
	end
