--[[---------------------------------------------------------------------------
	Entity Component.
	Provides lab3d.core.domain.Entity interface which contains common object 
	attributes such as name, position and scale and a data attribute that 
	points to a specific data container	type. \see lab3d.core.domai.IEntity.
--]]---------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
local Entity =  co.Component( "lab3d.core.domain.Entity" )
...
function Entity:__init()
	...
	self.bounds = self.bounds or co.new "lab3d.core.domain.BoundingBox"
	self.filename = ""
end
