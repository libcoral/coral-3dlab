...
#include <lab3d/core/scene/IActor.h>
#include <lab3d/core/domain/IView.h>
#include <lab3d/core/scene/ICamera.h>
...
static void updateCameraViewport( lab3d::core::scene::ICamera* camera, double w, double h )
{
...
void Scene::paint()
{
    lab3d::core::domain::IView* view = _activeCamera->getView();
    if( !view )
        return;
...
co::Range<lab3d::core::scene::IActor* const> Scene::getActors()
{
	// TODO: implement this method.
	return _actors;
}

void Scene::addActor( lab3d::core::scene::IActor* actor )
{
...
void Scene::removeActor( lab3d::core::scene::IActor* actor )
{
	for( ActorList::iterator it = _actors.begin(); it != _actors.end(); ) 
	{
        lab3d::core::scene::IActor* current = (*it).get();
		if( current == actor )
		{            
...
lab3d::core::scene::ICamera* Scene::getCamera()
{
	return _activeCamera.get();
}

void Scene::setCamera( lab3d::core::scene::ICamera* camera )
{
...
void Scene::setCameraDefaultSettings( lab3d::core::scene::ICamera* camera )
{
...
void Scene::copyCameraStateToOSG( lab3d::core::scene::ICamera* from, osg::Camera* to )
{
