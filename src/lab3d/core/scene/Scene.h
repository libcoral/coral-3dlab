...
public:
	...
	virtual co::Range<lab3d::core::scene::IActor* const> getActors();
	virtual void addActor( lab3d::core::scene::IActor* actor );
	virtual void removeActor( lab3d::core::scene::IActor* actor );
    virtual void update();
    virtual void clear();

	virtual lab3d::core::scene::ICamera* getCamera();
	virtual void setCamera( lab3d::core::scene::ICamera* camera );
...
private:
    void setupLight();
	void setCameraDefaultSettings( lab3d::core::scene::ICamera* camera );
	void copyCameraStateToOSG( lab3d::core::scene::ICamera* from, osg::Camera* to );

private:
    typedef co::RefVector<lab3d::core::scene::IActor> ActorList;
	ActorList _actors;
    ...
    co::RefPtr<lab3d::core::scene::ICamera> _activeCamera;
};
